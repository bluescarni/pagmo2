...
#include "../detail/try_demangle.hpp"
#include "../detail/location_from_symbol.hpp"
...
#   include "../detail/libbacktrace_impls.hpp"
#elif defined(BOOST_STACKTRACE_USE_ADDR2LINE)
#   include "../detail/addr2line_impls.hpp"
#else
#   include "../detail/unwind_base_impls.hpp"
#endif
